...
const SUBSCRIPTIONS: Subscription[] = [
  {
    ...
    status: "active",
    notes: "SweetLease ($107), Locust ($11), API ($11), Postgres ($16), Redis ($16), Grasshopper droplet ($6), Spaces ($5). Last month: $159.99",
  },
  {
    name: "Resend",
    category: "Email",
    ...
    renewalDate: "2026-04-01",
    status: "active",
    notes: "Transactional + outbound emails. Hive droplet hosts separately.",
  },
  {
    name: "RentCast",
    ...
    creditsUsed: 0,
    creditsTotal: 50,
    costPerCall: "$0.20 overage",
    notes: "50 free calls/mo. Next tier: Foundation $74/mo (1,000 calls, $0.06 overage)",
  },
  {
    name: "Apollo.io",
    ...
    renewalDate: "N/A",
    status: "active",
    costPerCall: "Credit-based (free tier)",
    notes: "People + org search for owner email/phone. Limited credits on free plan.",
  },
  {
    name: "PropertyReach",
    ...
    notes: "Property owner data, skip trace, linked properties. After trial: $159/mo (Core)",
  },
  {
    ...
    renewalDate: "N/A",
    status: "active",
    costPerCall: "$3/M input, $15/M output (Sonnet)",
    notes: "AI email generation for outbound sequences in Locust",
  },
  {
    name: "Mapbox",
    category: "Maps",
    ...
    renewalDate: "N/A",
    status: "active",
    notes: "100k free requests/mo. City autocomplete + map rendering.",
  },
  {
    name: "Stripe",
    category: "Payments",
    ...
    notes: "Tenant lease payments. No monthly fee — per-transaction only.",
  },
  {
    name: "Cal.com",
    category: "Scheduling",
    ...
    renewalDate: "N/A",
    status: "active",
    notes: "Meeting scheduling for landlord outreach calls",
  },
  {
    name: "Porkbun",
    category: "Email / DNS",
    ...
    status: "active",
    notes: "sweetlease.io domain + SMTP/IMAP for tgilbert@ and rgilbert@ inboxes",
  },
  {
    name: "ScraperAPI",
    ...
    notes: "Zillow photo + contact scraping proxy. 100k requests/mo.",
  },
];
